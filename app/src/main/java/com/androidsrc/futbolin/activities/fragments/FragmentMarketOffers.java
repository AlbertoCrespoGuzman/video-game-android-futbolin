 ...
 */
public class FragmentMarketOffers extends Fragment implements PlayerDialog.DialogClickListener{
    ...
    DatabaseManager db;
    TableRow headerRow;
    FragmentMarketOffers fragmentFollowing;
    Button backButton, buttonShowHide;

    public FragmentMarketOffers() {
    ...
    public static FragmentMarketOffers newInstance(getUser user, String param2) {
        FragmentMarketOffers fragment = new FragmentMarketOffers();
...
*/
    ...
    public void getMarketOffers() {
        ...
        SvcApi svc;
        svc = Svc.initAuth(getActivity());
        Call<getMarket> call = svc.getMarketOffers(Settings.Secure.getString(getActivity().getContentResolver(), Settings.Secure.ANDROID_ID));
